...
import pygame
import sys
from config import SCREEN_WIDTH, SCREEN_HEIGHT, BLOCK_SIZE, SCALE_SIZE, ZOOM_SPEED, BACKGROUND_COLOR, FPS
...
def main():
    ...
    TEXTURES = {
        "1": load_texture("assets/img/blocks/stone.png", BLOCK_SIZE, BLOCK_SIZE, SCALE_SIZE),    # Block type 1
        "2": load_texture("assets/img/blocks/grass.png", BLOCK_SIZE, BLOCK_SIZE, SCALE_SIZE),    # Block type 2
        "3": load_texture("assets/img/blocks/tree.png", BLOCK_SIZE, BLOCK_SIZE, SCALE_SIZE),     # Block type 3
        "4": load_texture("assets/img/blocks/grass1.png", BLOCK_SIZE, BLOCK_SIZE, SCALE_SIZE),   # Block type 4
        "5": load_texture("assets/img/blocks/block_5.png", BLOCK_SIZE, BLOCK_SIZE, SCALE_SIZE),  # Block type 5
        "empty": None,}
